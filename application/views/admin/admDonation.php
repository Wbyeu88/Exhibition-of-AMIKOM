        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="<?= base_url() ?>admin">Chart</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page"
                            href="<?= base_url() ?>admin/admDonation">Donation</a>
                    </li>
                    <!-- <li class="nav-item">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $key->id_donasi; ?></td>
                        <td><?php echo $key->email; ?></td>
                        <td>Rp. <?php echo $key->amount; ?></td>
                        <td><?php echo $key->note; ?></td>
                        <td><img src="<?php echo base_url('./assets/donation_files/' . $key->confirmation . ''); ?>"
                                width="100px"></td>
                        <!-- <td><?php echo $key->deskripsi; ?></td>
                            <td class="<?php
                                        ...
                                        ?> text-white" data-toggle="tooltip" data-placement="left" title="Bad weather condition"><?php
                                                                                                                                    if ($key->status == 1) {
                                                                                                                                        echo 'Approve';
                                                                                                                                    } else {
                                                                                                                                        echo 'Rejected';
                                                                                                                                    ...
                                                                                                                                    ?></td>
                            <td class="bg-info text-white" data-toggle="tooltip" data-placement="left" title="Bad weather condition">
