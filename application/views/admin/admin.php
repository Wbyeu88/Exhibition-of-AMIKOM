        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="<?= base_url() ?>admin">Chart</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="<?= base_url() ?>admin/admDonation">Donation</a>
                    </li>
                    <!-- <li class="nav-item">
...
Swal.fire({
  ...
  if (result.dismiss === Swal.DismissReason.timer) {
    ...
    <!-- Akhir Navbar -->
    <form action="<?= base_url('admin/approval'); ?>" method="POST">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="hapus.php?_id=<?php echo $data['id']; ?>">Hapus</a> -->
                                <!-- <input type="hidden" name="approve" value="<?php echo $key->id_karya; ?>"> -->
                                <button class="btn btn-success" type="submit" name="approve"
                                    value="<?php echo $key->id_karya; ?>">Approve</button>
                                <br>
                                <br>
                                <button class="btn btn-danger" type="submit" name="reject"
                                    value="<?php echo $key->id_karya; ?>">Reject</button>
                                <!-- <a href="<?= base_url() ?>admin/approveKarya">Approve</a>
                                    <a href="<?= base_url() ?>admin/approveKarya">Reject</a> -->
                                <br>
                            </td>
                        </tr>
                        <?php endforeach; ?>
